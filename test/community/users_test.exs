defmodule Community.UsersTest do
  ...
  describe "users" do
    ...
    import Community.UsersFixtures

    @invalid_attrs %{age: nil, cpf: nil, email: nil, name: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{age: 42, cpf: "some cpf", email: "some email", name: "some name"}
